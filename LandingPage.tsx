  ...
  return (
    <>
      ...
      <section className="sai-section" style={{background:'var(--bg2)'}}>
        <div className="sai-container">
          <div className="sai-task-grid">
            <div>
              <div className="sai-integ-logo-badge">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--txt)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 11l3 3L22 4"/>
                  <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>
                </svg>
                Task Planner
              </div>
              <div className="sai-section-label">Agentic Execution</div>
              <h2 className="sai-section-title">One prompt.<br/>Multiple tasks.</h2>
              <p className="sai-section-sub">Describe a complex change in plain English. SurgicalAI breaks it into discrete tasks, executes each through the full Architect → Surgeon → QA pipeline, and reports progress in real time.</p>
              <div className="sai-integ-bullets">
                <div className="sai-integ-bullet">
                  ...
                  <div>
                    ...
                    <p>Claude analyzes your request and decomposes it into ordered, dependency-aware tasks — code changes and explanations.</p>
                  </div>
                </div>
                <div className="sai-integ-bullet">
                  <div className="sai-integ-bullet-icon">⚡</div>
                  <div>
                    ...
                    <p>Each task runs through the full pipeline independently. If one fails QA, execution halts — no cascading broken code.</p>
                  </div>
                </div>
                <div className="sai-integ-bullet">
                  <div className="sai-integ-bullet-icon">🛑</div>
                  <div>
                    ...
                    <p>Running tasks can be cancelled mid-flight. Completed work is preserved — nothing gets rolled back.</p>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <div className="sai-task-mockup">
                <div className="sai-task-titlebar">
                  <div className="sai-dot sai-dot-r"></div>
                  <div className="sai-dot sai-dot-y"></div>
                  <div className="sai-dot sai-dot-g"></div>
                  <span className="sai-task-tbtitle">SurgicalAI — Task Planner</span>
                </div>
                <div className="sai-task-body" id="taskPlannerDemo">
                  <div className="sai-task-prompt">
                    <span className="sai-task-prompt-icon">💬</span>
                    <span className="sai-task-prompt-text" id="taskPromptText"></span>
                  </div>
                  <div className="sai-task-divider" id="taskDivider" style={{opacity:0}}>
                    <div className="sai-task-divider-line"></div>
                    <span className="sai-task-divider-label">4 Tasks Planned</span>
                    <div className="sai-task-divider-line"></div>
                  </div>
                  <div id="taskItemsContainer"></div>
                  <div className="sai-task-summary" id="taskSummary">
                    ✦ 4 / 4 tasks complete · All QA passed
                  </div>
                </div>
              </div>
            </div>
